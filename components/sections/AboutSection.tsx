...
export const AboutSection: React.FC<AboutSectionProps> = ({ data }) => (
  <Section id="about" className="">
    <h2 className="text-4xl sm:text-5xl font-extrabold text-center mb-12 sm:mb-16" style={{ color: 'var(--text-primary)' }}>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
      ...
      {/* Career Timeline */}
      <div className="md:col-span-1 border-l-4 pl-4 sm:pl-6 space-y-8" style={{ borderLeftColor: 'var(--border-medium)' }}>
        ...
        {data.about.timeline.map((event: any) => (
          <div key={event.year} className="relative">
            ...
            <p className="text-xl font-bold" style={{ color: 'var(--text-primary)' }}>{event.year}</p>
